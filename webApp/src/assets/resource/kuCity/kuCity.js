    ...
    KuCity.prototype = {
        ...
        creatItem: function() {
            ...
            var template = '<div class="kucity"><div class="citybox">' +
                '<h3 class="kucity_header">热门城市(支持汉字/拼音搜索)</h3><ul class="kucity_nav"><li class="active">热门城市</li>' +
                '<li>A~H</li><li>I~P</li><li>Q~Z</li></ul><div class="kucity_body"></div></div><ul class="result"></ul></div>';
